...
ventana = Tk()
ventana.title("Ejercicio completo con Tkinter | Luis Armando Lira")
...
def cFloat(numero):
    try:
        ...
        result = 0
        messagebox.showerror("Error","Error en los datos, por favor vuelve a introducirlos")
    return result
def sumar():
...
marco = Frame(ventana, width=340, height=250)
