...
ventana.title("Proyecto Tkinter - Master en Python | Luis Armando Lira González")
ventana.resizable(0,0)

# Pantallas
def home():
    # Montar pantalla
    home_label.config(fg="white",bg="black",font=("Arial",20),padx=170,pady=20)
...
def add():
    # Encabezado
    add_label.config(fg="white",bg="black",font=("Arial",20),padx=110,pady=20)
    add_label.grid(row=0,column=0,columnspan=10)

    # Campos del formulario
    add_frame.grid(row=2)
    ...
    add_description_entry.config(width=24,height=5,font=("Consolas",10),padx=10,pady=10)
...
def info():
    info_label.config(fg="white",bg="black",font=("Arial",20),padx=130,pady=20)
...
# productos_table.heading("#0",text="Producto",anchor=W)
...
data_label = Label(ventana,text="Creado por Luis Armando Lira González - 2024")
